...
public class ResidentNoticeRowController extends JFXListCell<Notice> implements Initializable {
    ...
    protected void updateItem(Notice mNotice, boolean empty) {
        ...
        if (empty || mNotice == null) {
            ...
            if (fxmlLoader == null) {
                fxmlLoader = new FXMLLoader(getClass().getResource("/sample/views/resident/resident_notice_row.fxml"));
            ...
            setOnMouseClicked(mouseClickedEvent -> {
                ...
                if (mouseClickedEvent.getButton().equals(MouseButton.PRIMARY)
                    ...
                    loader.setLocation(this.getClass().getResource("/sample/views/resident/resident_view_notice.fxml"));
                    try {
                        loader.load();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    ResidentViewNoticeController viewNoticeController = loader.getController();
